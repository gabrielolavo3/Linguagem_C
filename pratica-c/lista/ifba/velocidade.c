/* 
Descrição  : Ler um valor e aplicar a conversão de medida, seja de Km/h para M/s ou vice-versa, de acordo ao usuário.
Ao final, imprimir o valor inserido pelo usuário e o resultado da conversão! (função)
